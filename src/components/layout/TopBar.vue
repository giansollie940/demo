    ...
    <div class="context-controls">
      ...
      <div v-if="auth.currentUser" ref="profileMenu" class="profile-menu">
        ...
        <div v-if="profileOpen" class="profile-dropdown" role="menu">
          ...
          <RouterLink class="profile-settings" to="/settings" role="menuitem" @click="profileOpen=false"><SlidersHorizontal/>{{ auth.currentUser.role==='student'||auth.currentUser.role==='monitor'?'Tùy chọn cá nhân':'Cài đặt' }}</RouterLink>
