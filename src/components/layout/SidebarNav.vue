...
import { Building2, CalendarClock, CalendarRange, ChartNoAxesCombined, ClipboardCheck, GraduationCap, HardDrive, History, LayoutDashboard, MessagesSquare, NotebookPen, Settings, ShieldCheck, Trash2, TriangleAlert, UsersRound } from 'lucide-vue-next'
...
const icons:Record<string,Component>={LayoutDashboard,NotebookPen,ClipboardCheck,UsersRound,CalendarRange,CalendarClock,GraduationCap,ChartNoAxesCombined,History,MessagesSquare,ShieldCheck,TriangleAlert,Settings,Building2,Trash2,HardDrive}
...
.collapsed{padding-inline:0;gap:8px}.collapsed .nav-item{justify-content:center;min-height:48px;padding:5px 0;border-radius:17px;background:color-mix(in srgb,var(--surface) 68%,transparent);transform-origin:left center}.collapsed .nav-icon-bubble{width:38px;height:38px;flex-basis:38px;border-radius:14px}.collapsed .nav-item:hover,.collapsed .nav-item:focus-visible{box-shadow:0 19px 38px color-mix(in srgb,var(--nav-accent) 18%,transparent),0 7px 16px rgb(67 45 57 / .11)}
