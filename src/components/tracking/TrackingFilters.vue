...
<style scoped>
.tracking-controls{display:grid;gap:12px}.filter-chips{display:flex;gap:8px;overflow:auto;padding-bottom:2px}.filter-chips button{min-height:40px;border:1px solid var(--border);border-radius:999px;padding:8px 12px;background:var(--surface-raised);color:var(--text-muted);font-weight:800;white-space:nowrap}.filter-chips button.active{background:var(--gradient-primary);border-color:color-mix(in srgb,var(--color-primary) 65%,var(--border));color:var(--color-on-action);box-shadow:0 5px 14px color-mix(in srgb,var(--color-primary) 16%,transparent)}.search-sort{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px}.search{display:flex;align-items:center;gap:8px;border:1px solid var(--border);border-radius:12px;padding:0 11px;background:var(--surface-raised)}.search svg{width:17px;color:var(--text-muted)}.search input{min-width:0;width:100%;min-height:42px;border:0;outline:0;background:transparent;color:var(--text)}.sort{display:flex;align-items:center;gap:8px;color:var(--text-muted);font-size:.82rem}.sort select{min-height:42px;border:1px solid var(--border);border-radius:12px;background:var(--surface-raised);color:var(--text);padding:0 10px}@media(max-width:680px){.search-sort{grid-template-columns:1fr}.sort{justify-content:space-between}.sort select{flex:1}}
</style>
