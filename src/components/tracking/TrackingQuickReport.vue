...
<style scoped>
.quick-report{border:1px solid var(--border);border-radius:18px;overflow:hidden;background:color-mix(in srgb,var(--surface) 93%,transparent)}header{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:14px 16px;background:linear-gradient(135deg,var(--wash-cream),color-mix(in srgb,var(--wash-violet) 45%,var(--surface)))}.title{display:flex;align-items:center;gap:10px}.icon{width:38px;height:38px;border-radius:12px;display:grid;place-items:center;background:var(--surface);color:var(--color-primary);box-shadow:var(--shadow-sm)}.icon :deep(svg){width:19px}.title small{color:var(--text-muted);font-size:.69rem;font-weight:900;letter-spacing:.05em}.title h3{margin:2px 0 0}.count{min-width:42px;height:42px;padding:0 10px;border-radius:999px;display:grid;place-items:center;background:var(--surface);color:var(--color-primary);font-size:1.2rem}.table-wrap{overflow:auto}table{width:100%;border-collapse:collapse}th,td{padding:11px 14px;border-bottom:1px solid var(--border);text-align:left}th{font-size:.72rem;color:var(--text-muted);text-transform:uppercase;letter-spacing:.05em}td:first-child{width:52px;color:var(--text-muted)}.device-pill{display:inline-flex;padding:5px 9px;border-radius:999px;background:var(--surface-soft);font-size:.75rem;font-weight:850}.device-pill.device{background:var(--wash-mint);color:var(--color-success)}.device-pill.no-device{background:var(--wash-coral);color:var(--color-danger)}.device-pill.unknown-device{background:var(--wash-sun);color:var(--color-warning)}.empty{padding:24px;text-align:center;color:var(--text-muted)}
</style>
