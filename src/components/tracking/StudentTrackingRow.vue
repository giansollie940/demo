...
import { AlertTriangle, Check, Laptop2, MessageSquareText, PencilLine, Trash2, UserRoundX } from 'lucide-vue-next'
...
const props=defineProps<{row:TrackingRow;actions?:RegistrationManagerActions|null;busy?:boolean}>()
const emit=defineEmits<{approve:[];revision:[];comment:[];delete:[]}>()
