...
<template>
  <article class="session-card" :class="{ emergency: eligibility.emergencyAllowed || registration?.isEmergency, locked: !registration && !eligibility.regularNewAllowed && !eligibility.emergencyAllowed }">
...
<style scoped>
.session-card{display:grid;gap:16px;min-width:0;padding:20px;border:1px solid var(--border);border-radius:18px;background:var(--surface);box-shadow:var(--shadow-sm)}.session-card.emergency{border-color:color-mix(in srgb,var(--color-warning) 45%,var(--border));background:color-mix(in srgb,var(--color-warning) 5%,var(--surface))}.session-card.locked{background:var(--surface-soft)}header{display:flex;align-items:flex-start;justify-content:space-between;gap:12px}header span{color:var(--text-muted);font-size:.8rem;font-weight:750}header h2{margin:4px 0 0;font-size:1.3rem}.session-time,.device{display:flex;align-items:center;gap:8px;color:var(--text-muted);font-size:.88rem;font-weight:750}.session-time svg,.device svg{width:18px}.session-content p{margin:4px 0 0;color:var(--text-muted)}.feedback,.emergency-note{display:flex;gap:8px;margin:0;padding:12px;border-radius:12px;background:var(--surface-soft);color:var(--text-muted)}.feedback svg,.emergency-note svg{width:18px;flex:none}.ai-note{display:flex;gap:8px;margin:0;color:var(--text-muted)}.ai-note>span{align-self:start;padding:4px 8px;border-radius:999px;background:color-mix(in srgb,var(--color-primary) 12%,var(--surface));color:var(--color-primary);font-size:.72rem;font-weight:900}footer{display:flex;align-items:center;justify-content:flex-end;gap:8px;flex-wrap:wrap}footer :deep(svg){width:17px}@media(max-width:520px){header{flex-direction:column}footer{display:grid;grid-template-columns:1fr}footer :deep(button){width:100%}}
</style>
