...
<style scoped>
.registration-page{max-width:1500px;margin:0 auto}.registration-header{display:flex;align-items:flex-start;justify-content:space-between;gap:20px}.registration-header h1{margin:8px 0;font-size:clamp(2rem,4vw,3rem)}.registration-header p{margin:0;color:var(--text-muted)}.page-context,.syncing{display:flex;align-items:center;gap:8px;color:var(--color-primary);font-size:.86rem;font-weight:800}.page-context svg,.syncing svg{width:18px}.session-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.empty-registration{text-align:center}.empty-registration h2{margin-top:0}.empty-registration p{margin-bottom:0;color:var(--text-muted)}@media(max-width:820px){.session-grid{grid-template-columns:1fr}.registration-header{flex-direction:column}}
</style>
