...
.hero-copy{position:relative;z-index:2;display:grid;gap:7px;align-content:center;max-width:52%;min-height:84px;margin-left:auto}
...
@media(max-width:1100px){.dashboard-stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.dashboard-main-grid{grid-template-columns:1fr}.work-panel,.overview-panel{height:auto;min-height:300px}.dashboard-hero{display:grid;grid-template-columns:1fr;padding-bottom:0}.hero-copy{max-width:none;min-height:auto;margin-left:0}.hero-illustration{position:relative;inset:auto;width:100%;height:172px;margin-top:12px;overflow:hidden}.hero-illustration img{width:100%;height:172px;object-fit:cover;object-position:center 45%;-webkit-mask-image:none;mask-image:none}.overview-body{grid-template-columns:minmax(170px,220px) 1fr}}
