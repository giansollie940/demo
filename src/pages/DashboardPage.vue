...
const dashboardIllustrationUrl = `${import.meta.env.BASE_URL}assets/images/student-group-dashboard-blend.png`
...
<style scoped>
.dashboard-page{max-width:1292px;margin:0 auto;gap:16px}
.dashboard-hero{min-height:190px;display:block;padding:24px 28px;overflow:hidden;position:relative;background:radial-gradient(circle at 76% 24%,color-mix(in srgb,var(--wash-sky) 72%,transparent),transparent 31%),radial-gradient(circle at 8% 0%,color-mix(in srgb,var(--wash-pink) 72%,transparent),transparent 36%),linear-gradient(135deg,color-mix(in srgb,var(--surface) 98%,transparent),color-mix(in srgb,var(--wash-violet) 58%,var(--surface)));border-radius:24px}
...
.hero-copy{position:relative;z-index:2;display:grid;gap:7px;align-content:center;max-width:56%;min-height:142px}
.hero-kicker,.role-heading span,.panel-kicker{color:var(--color-primary);font-size:.69rem;font-weight:900;letter-spacing:.12em}
.hero-copy h1{margin:0;font-size:clamp(1.9rem,2.7vw,2.45rem);line-height:1.04;color:var(--text);letter-spacing:-.035em}
.hero-copy p{margin:0;max-width:62ch;color:var(--text-muted);font-size:.86rem}
.hero-meta{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-top:5px}
.week-pill{display:inline-flex;padding:7px 10px;border-radius:11px;background:color-mix(in srgb,var(--surface) 86%,transparent);border:1px solid color-mix(in srgb,var(--color-primary) 12%,var(--border));color:var(--text-muted);font-size:.74rem;font-weight:800}
.hero-illustration{position:absolute;inset:0 0 0 auto;width:min(52%,640px);height:100%;z-index:1;overflow:hidden;background:transparent;border:0;border-radius:0;box-shadow:none;pointer-events:none}
.hero-illustration img{width:100%;height:100%;object-fit:cover;object-position:center center;border-radius:0;filter:none;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.22) 8%,#000 27%,#000 100%);mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.22) 8%,#000 27%,#000 100%)}
...
@media(max-width:1400px){.dashboard-page{max-width:1180px}.hero-illustration{width:min(50%,590px)}.dashboard-main-grid{grid-template-columns:minmax(0,1.55fr) minmax(320px,.85fr)}}
@media(max-width:1100px){.dashboard-stat-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.dashboard-main-grid{grid-template-columns:1fr}.work-panel,.overview-panel{height:auto;min-height:300px}.dashboard-hero{display:grid;grid-template-columns:1fr;padding-bottom:0}.hero-copy{max-width:none;min-height:auto}.hero-illustration{position:relative;inset:auto;width:100%;height:160px;margin-top:12px;overflow:hidden}.hero-illustration img{width:100%;height:160px;object-fit:cover;object-position:center 45%}.overview-body{grid-template-columns:minmax(170px,220px) 1fr}}
