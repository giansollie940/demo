...
.hero-illustration img{width:100%;height:100%;object-fit:cover;object-position:center 48%;border-radius:0;filter:none;image-rendering:auto;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.22) 8%,#000 27%,#000 100%);mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.22) 8%,#000 27%,#000 100%)}
