...
.hero-illustration{position:absolute;inset:0 auto 0 50%;width:min(52%,640px);height:100%;z-index:1;overflow:hidden;background:transparent;border:0;border-radius:0;box-shadow:none;pointer-events:none}
