...
.hero-kicker,.role-heading span,.panel-kicker{color:var(--color-primary);font-size:.74rem;font-weight:900;letter-spacing:.12em}
...
.week-pill{display:inline-flex;padding:7px 10px;border-radius:11px;background:color-mix(in srgb,var(--surface) 86%,transparent);border:1px solid color-mix(in srgb,var(--color-primary) 12%,var(--border));color:var(--text-muted);font-size:.79rem;font-weight:800}
...
.hero-illustration img{width:100%;height:100%;object-fit:contain;object-position:right bottom;border-radius:0;filter:none;image-rendering:auto;-webkit-mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.22) 8%,#000 27%,#000 100%);mask-image:linear-gradient(90deg,transparent 0%,rgba(0,0,0,.22) 8%,#000 27%,#000 100%)}
