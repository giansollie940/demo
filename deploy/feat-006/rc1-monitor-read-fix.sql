-- FEAT-006 RC1 -> RC2 function-only patch, after RC1 migration 10.
-- For fresh RC2 installs use updated migration 10 instead. No data rewrite.
begin;
...
revoke all on function public.homework_media(text,jsonb) from public,anon,authenticated;
grant execute on function public.homework_media(text,jsonb) to authenticated;
commit;
