-- FEAT-001 R3: repair AI retries for databases that already applied R2 migration 05.
-- Transactional, no DROP/TRUNCATE/DELETE and no modification of stored notices.
-- On a fresh database apply 05 first. Safe to re-run 06.
begin;
...
revoke all on function homework_private.card(public.homework_notices,uuid) from public,anon,authenticated;
