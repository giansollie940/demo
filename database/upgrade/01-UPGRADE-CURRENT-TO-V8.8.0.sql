...
begin
  ...
  then
    ...
    -- approved_at to null regardless of what the client sends. Allow exactly
    -- that reset shape; any other value for these two columns is still
    -- rejected, on this row or any other.
